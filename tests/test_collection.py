...
def test_Collection_attrs(collection):
    ...
    assert collection.librarySectionKey == "/library/sections/{}".format((collection.librarySectionID))
    ...
    assert collection.thumb.startswith("/library/collections/{}/composite".format((collection.ratingKey)))
